        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">All Whatsapp Messages</h3>
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <router-link to="/messages" class="kt-subheader__breadcrumbs-link">All Whatsapp Messages</router-link>
                    </div>
                </div>>
            </div>
        </div>
            ...
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__body">
                    ...
                    <div v-show="isRequestCompleted">
                        <table class="table table-striped table-hover table-checkable" id="whatsappMessagesTable" >
                            <thead>
                                <tr>
                                    <th>Sender Name</th>
                                    <th>Email</th>
                                ...
                                <tr v-for="message in messages" :key="message.id">
                                        ...
                                        <td data-field="Actions" data-autohide-disabled="false" class="kt-datatable__cell">
                                            <span style="overflow: visible; position: relative; width: 110px;">
                                                <!-- <router-link :to="{name:'single-message', params: {id: message.id, name:message.firstName.split(' ').join('_') }}" title="View message" class="btn btn-sm btn-clean btn-icon btn-icon-md"><i class="la la-eye"></i></router-link> -->
...
export default {
    ...
    methods:{
        mytable(){
            setTimeout(function() {
                $("#whatsappMessagesTable").DataTable( {
                    dom: 'lBfrtip',
                    pageLength : 25,
                    buttons: [
                ...
                $("#whatsappMessagesTable_filter label").css({'float':'right', 'margin-top': '-50px'});
            }, 500);
        },
        deletemessage(id){
            let object = this;
            iziToast.question({
                ...
                buttons: [
                    ['<button><b>YES</b></button>', function (instance, toast) {
                        ...
                        object.axios
                            .get(`${object.$appUrl}whatsapp/delete/${id}`)
                            .then(response => {
                                iziToast.success({
                                ...
                                $("#whatsappMessagesTable").DataTable().destroy();
