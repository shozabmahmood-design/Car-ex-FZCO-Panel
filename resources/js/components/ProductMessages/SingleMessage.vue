            ...
            <div class="kt-container  kt-container--fluid ">
                ...
                <div class="kt-subheader__toolbar">
                    <div class="kt-subheader__wrapper">
                        <router-link to="/product/messages" class="btn btn-brand btn-elevate btn-icon-sm"><i class="la la-list-ul"></i> All Messages &nbsp;</router-link>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="kt-portlet__body">
                                <div class="kt-infobox">
                                    ...
                                    <div class="form-group">
                                        <router-link to="/product/messages" class="btn btn-success"><i class="la la-caret-left"></i> Back to all Messages</router-link>
    ...
    export default {
        ...
        methods:{
            deletemessage(id){
                ...
                this.$router.push('/product/messages')
            }
        }
    }
</script>