        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <span class="kt-subheader__desc">Update Type</span>
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white" id="kt_contacts_add" data-ktwizard-state="step-first">
                        ...
                        <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                            ...
                            <form class="kt-form" @submit.prevent="updateType">
                                <!--begin: Form Wizard Step 1-->
                                <div class="kt-wizard-v1__content">
                                    <div class="kt-heading kt-heading--md">Update {{ type.vehicleType }}:</div>
...
export default {
    ...
    created(){
        this.axios
            .get(`${this.$appUrl}types/${this.$route.params.id}`)
            .then((response) => {
                this.type = response.data;
                this.image = this.$uploadsUrl + this.type.image;
            });
    },
    methods: {
        updateType(){
